...
class _CareMapScreenState extends State<CareMapScreen>
      ...
      callback: (result, errorCode) {
        if (errorCode == BMFSearchErrorCode.NO_ERROR &&
          ...
          if (mounted) {
            ...
            NotificationHelper.showWarning(message: '未找到周边医院');
          }
        }
      },
    );
  ...
  Widget _buildHomeLocationTab(bool isDark, ColorScheme colorScheme) {
    return Column(
      children: [
        ...
        Expanded(flex: 2, child: _buildHomeLocationPanel(isDark, colorScheme)),
      ],
    );
  }
  ...
  Widget _buildHospitalTab(bool isDark, ColorScheme colorScheme) {
    return Column(
      children: [
        Expanded(flex: 3, child: _buildMapView()),
        Expanded(flex: 2, child: _buildHospitalPanel(isDark, colorScheme)),
      ],
    );
  }
